...
$(function () {
  ...
  $('#calendar').calendar({
    ...
    $("#calendar-date li").click(function(){
          ...
          //document.getElementById("create_time").value=$(this).attr("data")
            $("input[name='create_time']").attr("value",$(this).attr("data"));
    ...
    inital: function () { // 初始化
      ...
      if (this.opts.backToday) {
        this.$backToday.bind('click', function () {
        	 $("#calendar-date li").removeClass("navClicked"); //移除选中效果
